...
$('#lii_newin_for_deliqa').empty();
$('#lii_newin_for_deliq1a').empty();
$('#deliqshow1a').hide();
$('#deliqshow2a').hide();
$('#lii_newinuia').show();
...
$('#lii_newin_for_deliq1a').append(liii);
...
$('#lii_newin_for_deliqa').append(liiiu);
...
var oneemp=employimg_obj.document;
//alert(oneemp);
  $('.sddqiveri').append('<li><a href="http://fourthforce.in/verify/uploads/'+oneemp+'"><img src="http://fourthforce.in/verify/uploads/'+oneemp+'" style="height: 100%;width:100%" ></a></li>');
